            ...
            <section className="api-reference">
              ...
              <section className="api-reference-section" id="api-auth">
                ...
                <div className="api-code-card">
                  ...
                  <pre>{`curl -X GET https://deca-management.vercel.app/api/data/query?resource=summary \\
  -H "Authorization: Bearer YOUR_DECA_API_KEY"`}</pre>
                  <button className="btn ghost" type="button" onClick={() => onCopy(`curl -X GET https://deca-management.vercel.app/api/data/query?resource=summary \\\n  -H "Authorization: Bearer YOUR_DECA_API_KEY"`)}>复制</button>
                </div>
              </section>
  ...
  "data": {
    ...
    "total_views": 123456
              ...
              <section className="api-reference-section" id="api-accounts">
                ...
                <div className="api-code-card">
                  <div className="api-code-head">Example Request</div>
                  <pre>{`curl "https://deca-management.vercel.app/api/data/query?resource=accounts&product_code=DB&country_code=GE&days=7" \\
  -H "Authorization: Bearer YOUR_DECA_API_KEY"`}</pre>
                  <button className="btn ghost" type="button" onClick={() => onCopy(`curl "https://deca-management.vercel.app/api/data/query?resource=accounts&product_code=DB&country_code=GE&days=7" \\\n  -H "Authorization: Bearer YOUR_DECA_API_KEY"`)}>复制</button>
                </div>
              </section>
              ...
              <section className="api-reference-section" id="api-posts">
                ...
                <div className="api-code-card">
                  <div className="api-code-head">Example Request</div>
                  <pre>{`curl "https://deca-management.vercel.app/api/data/query?resource=posts&product_code=DB&country_code=GE&date_from=2026-04-30&limit=50" \\
  -H "Authorization: Bearer YOUR_DECA_API_KEY"`}</pre>
                  <button className="btn ghost" type="button" onClick={() => onCopy(`curl "https://deca-management.vercel.app/api/data/query?resource=posts&product_code=DB&country_code=GE&date_from=2026-04-30&limit=50" \\\n  -H "Authorization: Bearer YOUR_DECA_API_KEY"`)}>复制</button>
                </div>
              </section>
              ...
              <section className="api-reference-section">
                ...
                <div className="api-code-card">
                  <div className="api-code-head">Example Request</div>
                  <pre>{`curl "https://deca-management.vercel.app/api/data/query?resource=account_posts&product_code=DB&country_code=GE&account_id=user123&limit=4&offset=0" \\
  -H "Authorization: Bearer YOUR_DECA_API_KEY"`}</pre>
                </div>
              </section>
              ...
              <section className="api-reference-section">
                ...
                <div className="api-code-card">
                  <div className="api-code-head">Example Request</div>
                  <pre>{`curl "https://deca-management.vercel.app/api/data/query?resource=materials&product_code=DB&country_code=GE&limit=50" \\
  -H "Authorization: Bearer YOUR_DECA_API_KEY"`}</pre>
                </div>
              </section>
              ...
              <section className="api-reference-section" id="api-trends">
                ...
                <div className="api-code-card">
                  <div className="api-code-head">Example Request</div>
                  <pre>{`curl "https://deca-management.vercel.app/api/data/query?resource=daily_metrics&product_code=DB&country_code=GE&days=7" \\
  -H "Authorization: Bearer YOUR_DECA_API_KEY"`}</pre>
                </div>
              </section>
              ...
              <section className="api-reference-section">
                ...
                <div className="api-code-card">
                  <div className="api-code-head">Example Request</div>
                  <pre>{`curl "https://deca-management.vercel.app/api/data/query?resource=top_posts&product_code=DB&country_code=GE&metric=view_count&limit=20" \\
  -H "Authorization: Bearer YOUR_DECA_API_KEY"`}</pre>
                </div>
              </section>
