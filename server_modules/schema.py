...
def init_relational_schema(conn, is_postgres=False, placeholder="?"):
    statements = [
        ...
        "CREATE INDEX IF NOT EXISTS idx_posts_material_published_at ON posts(material_id, published_at)",
        "CREATE INDEX IF NOT EXISTS idx_materials_automation_id ON materials(automation_id)",
        "CREATE INDEX IF NOT EXISTS idx_materials_created_at ON materials(created_at)",
        "CREATE INDEX IF NOT EXISTS idx_materials_automation_created_at ON materials(automation_id, created_at)",
